...
/* ── Usuarios Activos: contador discreto en el header ──
   Ícono de personas con un punto verde y el número al lado; el detalle
   de quién está activo se muestra en el tooltip. */
